...
<?php 
    ...
    $id = $_SESSION['userid_restaurant_qRewacvAqzA'];
...
?>
    ...
    <header class="headerMenu сlearfix sb-page-header">   
        <div class="nav-header">
         ...
         <center><h4 class="welcomemssg"><?php echo "$greeting ". $fetch['username']?></h4></center>
                ...
                <li id="user-btn" class="main-li dropdown" style="background:none;">
                    <div class="dropdown show">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <?php   
                                    $result = $con->prepare("SELECT * FROM users ORDER BY user_id DESC");
                                    $result->execute();
                                    for($i=0; $users = $result->fetchAll(); $i++){
                                   
                                    }?>
                                </a> <?php  
                                                            ?>
                            <a class="dropdown-item" href="editform.php?id=<?php echo $_SESSION['userid_restaurant_qRewacvAqzA']; ?>">
