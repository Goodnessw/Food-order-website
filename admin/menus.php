                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                              ...
                                                                              <a href="menus.php"><button type="button" data-id = "<?php echo $menu['menu_id']; ?>" class="btn btn-danger delete_menu_bttn">Delete</button></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <form method="POST" class="menu_form" action="menus.php?do=Add" enctype="multipart/form-data">
                                <div class="panel-X">
                                    ...
                                    <div class="save-header-X">
                                        ...
                                        <a href="menus.php"><button type="submit" name="add_new_menu" class="btn btn-primary">Save</button></a>
                                        </div>
                                    </div>
